...
public class ToolItemDropDownMenu {
  ...
  public static void main(String[] args) {
    ...
    Button button =  new Button(toolBar, SWT.DROP_DOWN);
    
  /*  ToolItem item = new ToolItem(toolBar, SWT.DROP_DOWN);
    item.setText("One");

    DropdownSelectionListener1 listenerOne = new DropdownSelectionListener1(item);
...
class DropdownSelectionListener1 extends SelectionAdapter {
  private ToolItem dropdown;

  private Menu menu;

  public DropdownSelectionListener1(ToolItem dropdown) {
