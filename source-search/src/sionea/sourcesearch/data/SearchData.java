...
public class SearchData {
	 ...
	 * result = prime * result + ((filterOwner == null) ? 0 :
	 * filterOwner.hashCode()); result = prime * result + ((filterPackage == null) ?
	 * 0 : filterPackage.hashCode()); result = prime * result + ((searchString ==
	 * null) ? 0 : searchString.hashCode()); result = prime * result +
	 * ((sourceNameFilter == null) ? 0 : sourceNameFilter.hashCode()); return
	 * result; } (non-Javadoc)
	 * 
	 ...
	 * false; SearchData other = (SearchData) obj; if (filterOwner == null) { if
	 * (other.filterOwner != null) return false; } else if
	 * (!filterOwner.equals(other.filterOwner)) return false; if (filterPackage ==
	 * null) { if (other.filterPackage != null) return false; } else if
	 * (!filterPackage.equals(other.filterPackage)) return false; if (searchString
	 * == null) { if (other.searchString != null) return false; } else if
	 * (!searchString.equals(other.searchString)) return false; if (sourceNameFilter
	 * == null) { if (other.sourceNameFilter != null) return false; } else if
	 * (!sourceNameFilter.equals(other.sourceNameFilter)) return false; return true;
	 * }
	 * 
	 */
